    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <h1 style="font-size:200%; solid DodgerBlue;text-transform: uppercase"> Details of Users</h1>
...
$query_st = "SELECT * FROM register_can ";
...
$count=1;
$result = mysqli_query($conn,$query_st);
