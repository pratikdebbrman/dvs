...
<input class="form-control form-control-user border-0 small required" type="text" name="meetlink" placeholder="Enter meet link"><br><br>
<input class="btn btn-primary" type="submit" name="link_send_button" value="Send link to user" /><br><br>
    
    <?php 
    $link_var=$_POST["meetlink"];
                    }
                    else
                    {
...
$sql = "INSERT INTO meet_link(meet_link_column)VALUES ('$link_var')";
