...
<body id="page-top">
  <!-- <iframe src="https://script.google.com/macros/s/AKfycbwUN1x0PEBOja_D1k6KmiZD1JJW-y4nleRsUcdgLaQlvINNmJE/exec" width="100" height="500"></iframe> -->
...
<div id="wrapper">
  ...
  <!-- <form action="upload_final_e.php" method="post" enctype="multipart/form-data"> 
  ...
  <?php 
                      ...
                      {
                      ?> -->
 <!--   <a href="https://script.google.com/macros/s/AKfycbwUN1x0PEBOja_D1k6KmiZD1JJW-y4nleRsUcdgLaQlvINNmJE/exec" >  <input type="submit" class="btn btn-primary" value="Click here to upload your Certificates"><br><br></a> -->
...
if($row_st['4']=='V')
                      {?>
                        <br/>
                          ...
                          <center><a href="/BENGALATHON/odp1/login/dept/user/image_store/certificates_user/e.pdf"><b><p style="font-size: 40px;">To Apply Offline  Download Form</p></b></a></center>
                          <center><a href="/BENGALATHON/odp1/login/dept/user/image_store/form_fill_e.php"><b><p style="font-size: 40px;">To Apply Online</p></b></a></center>
                         <?php
                       }
                       if($row_st['4']=='N')
                       {?>
