...
<div id="wrapper">
 ...
 <form action="" method="post" enctype="multipart/form-data">
  ...
  <!-- <form action="upload_final_tevtsd.php" method="post" enctype="multipart/form-data"> 
...
if($row_st['4']=='V')
                      {?>
                        <br/>
                          ...
                          <center><a href="/BENGALATHON/odp1/login/dept/user/image_store/certificates_user/tevtsd.pdf"><b><p style="font-size: 40px;">To Apply Offline  Download Form</p></b></a></center>
