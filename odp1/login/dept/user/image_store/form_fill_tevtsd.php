    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <h1 style="font-size:150%; solid DodgerBlue;text-transform: Uppercase">Technical education & vocational training and skill development</h1>
...
<form action="insert/insert_applying_tevtsd.php" method="post">
 <div>
   <center>
