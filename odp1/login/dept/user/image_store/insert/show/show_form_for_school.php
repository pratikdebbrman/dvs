    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <h1 style="font-size:200%; solid DodgerBlue;text-transform: uppercase">Details of form filled By You</h1>
...
$query="SELECT * from applied_school_user ORDER BY id desc";
